...
public class BrakeInterrupt
{
	...
	public static class Base extends com.rational.rosert.RootProtocolRole
	{
		...
		public static final int rti_ReleaseBrake = rtiLast_RootProtocolRole + 2;
		...
		public final InSignal ReleaseBrake()
		{
			return new InSignal( rti_ReleaseBrake );
		}
	...
	public static class Conjugate extends com.rational.rosert.RootProtocolRole
	{
		...
		public final OutSignal ApplyBrake()
		{
			return new OutSignal( Base.rti_ApplyBrake );
		}
		public final OutSignal ReleaseBrake()
		{
			return new OutSignal( Base.rti_ReleaseBrake );
		}
	}
	// }}}RME
}
