...
public class CommandLeverSensor extends com.rational.rosert.Capsule
{
	...
	// }}}RME
	// {{{RME transition ':TOP:Deactivate:TopGearEngaged:J4FC8E83601A6:topGearDisengaged'
	protected void rtTransition4_topGearDisengaged()
	{
		setTopGearEngaged(false);
	...
	protected void chain4_topGearDisengaged()
	{
		...
		rtExitState();
		rtTransitionBegin();
		rtTransition4_topGearDisengaged();
		rtTransitionEnd();
		rtEnterState( 3 );
