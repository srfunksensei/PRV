...
public class ACCSGUIPanel extends javax.swing.JPanel
{
	...
	// }}}RME
	// {{{RME classAttribute 'lastButtonClicked'
	public static int lastButtonClicked;
	// }}}RME
	// {{{RME classAttribute 'wSpeed'
	public static double wSpeed = 0.005;
	// }}}RME
	// {{{RME classAttribute 'wThrottle'
	public static double wThrottle = 0.005;
	// }}}RME
	// {{{RME classAttribute 'speedManual'
	public static int speedManual;
	// }}}RME
	// {{{RME classAttribute 'throttleManual'
	public static int throttleManual;
	// }}}RME
	// {{{RME classAttribute 'speedFP'
	public static boolean speedFP = false;
	// }}}RME
	...
	{
		try{
			double w = Double.parseDouble(textFieldThrootleW.getText());

			if(w > 0.5) setErrorMsg("ERROR: frequency too high!");
			else {
				wThrottle = w;
				clearErrorMsg();

				lastButtonClicked = ButtonValues.btnSetThrottleParam;
			}
		} catch (NumberFormatException ex){
			setErrorMsg("ERROR: Not double!");
		}
	}
	// }}}RME
	...
	{
		try{
			double w = Double.parseDouble(textFieldSpeedW.getText());
			...
			if(w > 0.5) setErrorMsg("ERROR: frequency too high!");
				...
				speedFP = true;
				lastButtonClicked = ButtonValues.btnSetSpeedParam;
			}
		} catch (NumberFormatException ex){
			setErrorMsg("ERROR: Not double!");
		}
	...
	{
		try {
				throttleManual = Integer.parseInt(textFieldThrottle.getText());

				textFieldThrottle.setText("");
				clearErrorMsg();

				lastButtonClicked = ButtonValues.btnSetThrottle;
			} catch (Exception e) {
				setErrorMsg("ERROR: Not integer!");
			}
	}
	// }}}RME
	...
	{
		try {
				speedManual = Integer.parseInt(textFieldSpeed.getText());

				textFieldSpeed.setText("");
				clearErrorMsg();

				lastButtonClicked = ButtonValues.btnSetSpeed;
			} catch (Exception e) {
				setErrorMsg("ERROR: Not integer!");
			}
	}
	...
	public void toggleBtnBrakeActionPerformed( java.awt.event.ActionEvent evt )
	{
		brakeApplied = toggleBtnBrake.isSelected();
				...
				if (brakeApplied) {
					...
					lastButtonClicked = ButtonValues.btnApplyBrake;
				} else {
					toggleBtnBrake.setText(strApplyBrake);
					lastButtonClicked = ButtonValues.btnReleaseBrake;
				}
	...
	public void btnCommandLeverSensorResumeActionPerformed( java.awt.event.ActionEvent evt )
	{
		...
		lastButtonClicked = ButtonValues.btnResume;
	}
	// }}}RME
	...
	public void btnCommandLeverSensorStopAccelerationActionPerformed( java.awt.event.ActionEvent evt )
	{
		...
		lastButtonClicked = ButtonValues.btnStopAcc;
	}
	// }}}RME
	...
	public void btnCommandLeverSensorStartAccelerationActionPerformed( java.awt.event.ActionEvent evt )
	{
		...
		lastButtonClicked = ButtonValues.btnStartAcc;
	}
	// }}}RME
	...
	public void btnCommandLeverSensorDeactivateActionPerformed( java.awt.event.ActionEvent evt )
	{
		...
		lastButtonClicked = ButtonValues.btnDeactivate;
	}
	// }}}RME
	...
	public void btnCommandLeverSensorActivateActionPerformed( java.awt.event.ActionEvent evt )
	{
		...
		lastButtonClicked = ButtonValues.btnActivate;
	}
	// }}}RME
	...
	public void toggleBtnTopGearActionPerformed( java.awt.event.ActionEvent evt )
	{
		topGearEngaged = toggleBtnTopGear.isSelected();
				...
				if (topGearEngaged) {
					...
					lastButtonClicked = ButtonValues.btnEngageTopGear;
				} else {
					toggleBtnTopGear.setText(strTopGearEngaged);
					lastButtonClicked = ButtonValues.btnDisengageTopGear;
				}
	...
	public void toggleBtnEngineActionPerformed( java.awt.event.ActionEvent evt )
	{
		if (toggleBtnTopGear.isSelected() || toggleBtnBrake.isSelected()) {
			...
			toggleBtnEngine.setSelected(false);
		} else {
			clearErrorMsg();

			if (!engineOn) {
				toggleBtnEngine.setText(strStopEngine);
				toggleBtnTopGear.setEnabled(false);
				lastButtonClicked = ButtonValues.btnEnable;
			} else {
				toggleBtnEngine.setText(strStartEngine);
				lastButtonClicked = ButtonValues.btnDisable;

				toggleBtnTopGear.setText(strTopGearEngaged);
				toggleBtnTopGear.setSelected(false);
				toggleBtnTopGear.setEnabled(true);
	...
	public void initComponents()
	{
		jSeparator7 = new javax.swing.JSeparator();
				...
				lblActualVoltage.setText("0.0 V");
	...
	// }}}RME
	// {{{RME operation 'addButtonEventEngine(ButtonEvent)'
	public void addButtonEventEngine( ButtonEvent eventHandler )
	{
		toggleBtnEngine.addMouseListener((java.awt.event.MouseListener) new ListenerA(this, eventHandler));
	}
	// }}}RME
	// {{{RME operation 'addButtonEventBrake(ButtonEvent)'
	public void addButtonEventBrake( ButtonEvent eventHandler )
	{
		toggleBtnBrake.addMouseListener((java.awt.event.MouseListener) new ListenerA(this, eventHandler));
	}
	// }}}RME
	// {{{RME operation 'addButtonEventTopGear(ButtonEvent)'
	public void addButtonEventTopGear( ButtonEvent eventHandler )
	{
		toggleBtnTopGear.addMouseListener((java.awt.event.MouseListener) new ListenerA(this, eventHandler));
	}
	// }}}RME
	// {{{RME operation 'addButtonEventStopAcc(ButtonEvent)'
	public void addButtonEventStopAcc( ButtonEvent eventHandler )
	{
		btnCommandLeverSensorStopAcceleration.addMouseListener((java.awt.event.MouseListener) new ListenerA(this, eventHandler));
	}
	// }}}RME
	// {{{RME operation 'addButtonEventStartAcc(ButtonEvent)'
	public void addButtonEventStartAcc( ButtonEvent eventHandler )
	{
		btnCommandLeverSensorStartAcceleration.addMouseListener((java.awt.event.MouseListener) new ListenerA(this, eventHandler));
	}
	// }}}RME
	// {{{RME operation 'addButtonEventResume(ButtonEvent)'
	public void addButtonEventResume( ButtonEvent eventHandler )
	{
		btnCommandLeverSensorResume.addMouseListener((java.awt.event.MouseListener) new ListenerA(this, eventHandler));
	}
	// }}}RME
	// {{{RME operation 'addButtonEventDeactivate(ButtonEvent)'
	public void addButtonEventDeactivate( ButtonEvent eventHandler )
	{
		btnCommandLeverSensorDeactivate.addMouseListener((java.awt.event.MouseListener) new ListenerA(this, eventHandler));
	}
	// }}}RME
	// {{{RME operation 'addButtonEventActivate(ButtonEvent)'
	public void addButtonEventActivate( ButtonEvent eventHandler )
	{
		btnCommandLeverSensorActivate.addMouseListener((java.awt.event.MouseListener) new ListenerA(this, eventHandler));
	}
	// }}}RME
	// {{{RME operation 'addButtonEventManualSpeed(ButtonEvent)'
	public void addButtonEventManualSpeed( ButtonEvent eventHandler )
	{
		btnSetManualSpeed.addMouseListener((java.awt.event.MouseListener) new ListenerMP(this, eventHandler));
	}
	// }}}RME
	// {{{RME operation 'addButtonEventManualThrottle(ButtonEvent)'
	public void addButtonEventManualThrottle( ButtonEvent eventHandler )
	{
		btnSetManualThrottle.addMouseListener((java.awt.event.MouseListener) new ListenerMP(this, eventHandler));
	}
	// }}}RME
	// {{{RME operation 'addButtonEventSpeedParams(ButtonEvent)'
	public void addButtonEventSpeedParams( ButtonEvent eventHandler )
	{
		btnSetSpeed.addMouseListener((java.awt.event.MouseListener) new ListenerFP(this, eventHandler));
	}
	// }}}RME
	// {{{RME operation 'addButtonEventThrottleParams(ButtonEvent)'
	public void addButtonEventThrottleParams( ButtonEvent eventHandler )
	{
		btnSetThrottle.addMouseListener((java.awt.event.MouseListener) new ListenerFP(this, eventHandler));
	}
	// }}}RME
	// {{{RME operation 'setEnableBtnTopGear(boolean)'
	public void setEnableBtnTopGear( boolean enable )
	{
		toggleBtnTopGear.setEnabled(enable);
	}
	// }}}RME
	// {{{RME operation 'getW()'
	public void getW()
	{
		try{
			double w = Double.parseDouble(textFieldThrootleW.getText()), 
					w1 = Double.parseDouble(textFieldSpeedW.getText());
