...
public class ACCS extends com.rational.rosert.Capsule
{
	...
	protected com.rational.rosert.BindingEnd rtFollowInV( int relay, int index )
	{
		...
		{
		case 0: // Apply_Brake
			if( index < 1 ) // brakeSensor/Apply_Brake
				return rtFollowIn( this.brakeSensor, 1, index );
			break;
		case 1: // Enable_Engine
			if( index < 1 ) // engineSensor/Enable_Engine
				return rtFollowIn( this.engineSensor, 1, index );
			break;
		case 2: // TopGearEngage
			if( index < 1 ) // gearSensor/TopGearEngage
				return rtFollowIn( this.gearSensor, 0, index );
			break;
		case 3: // Command
	...
	protected com.rational.rosert.BindingEnd rtFollowOutV( int role, int relay, int index )
	{
		...
		case 0: // brakeSensor
			...
			case 0: // Brake_Interrupt
				...
				break;
			case 1: // Apply_Brake
				if( index < 1 ) // Apply_Brake
					return rtFollowOut( 0, index );
				break;
			default:
				break;
			}
		...
		case 3: // gearSensor
			...
			case 0: // TopGearEngage
				if( index < 1 ) // TopGearEngage
					return rtFollowOut( 2, index );
				break;
		...
		case 4: // throttleActuator
			...
			case 1: // Command
				...
				break;
			case 2: // ACCS_Voltage
				if( index < 1 ) // ACCS_Voltage
					return rtFollowOut( 4, index );
				break;
			default:
				break;
			}
		...
		case 5: // throttleSensor
			...
			case 0: // Manual_Parameters
				if( index < 1 ) // Throttle_Manual_Parameters
					return rtFollowOut( 8, index );
				break;
			case 1: // Enable_Engine
				if( index < 1 ) // engineSensor/ToggleEngine
			...
			case 2: // Actual_Voltage
				if( index < 1 ) // Sensor_Actual_Voltage
					return rtFollowOut( 9, index );
				break;
			case 3: // Function_Parameters
				if( index < 1 ) // Throttle_Function_Parameters
					return rtFollowOut( 7, index );
				break;
		...
		case 6: // wheelShaftSensor
			...
			case 1: // Function_Parameters
				if( index < 1 ) // Wheel_Shaft_Function_Parameters
					return rtFollowOut( 5, index );
				break;
			case 2: // Manual_Parameters
				if( index < 1 ) // Wheel_Shaft_Manual_Parameters
					return rtFollowOut( 6, index );
				break;
			...
			case 4: // Curr_Speed
				...
				else if( index < 2 ) // Curr_Speed
					return rtFollowOut( 10, index - 1 );
				break;
			case 5: // ReachedSavedSpeed
