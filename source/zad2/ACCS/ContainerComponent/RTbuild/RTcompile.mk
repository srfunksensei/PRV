...
JAVAC_PATHSEP = ;
JAVAC_CLASSPATH = -classpath ".$(JAVAC_PATHSEP)C:\Documents and Settings\!Fantazio!\My Documents\ACCS/GUIComponent$(JAVAC_PATHSEP)C:\Documents and Settings\!Fantazio!\My Documents\NetBeansProjects\ACCS\src\rs\etf\prv\accs$(JAVAC_PATHSEP)$(ROSERT_HOME)/RTJava/classes.jar$(JAVAC_PATHSEP)%CLASSPATH%"
JAVAC_USEROPTS =
JAVAC_HEAD = $(JAVAC) $(JAVAC_CLASSPATH) $(JAVAC_USEROPTS)

ALL_COMPILATION_TARGETS = \
	RTbuild/ACCSSystem/ACCS_Container.ctg \
...
ALL_COMPILED_CLASSES = \
	"$(OUTPUT_CLASS_DIR)/ACCSSystem/ACCS_Container.class" \
...
OUTPUT_CLASS_DIR = C:\Documents and Settings\!Fantazio!\My Documents\ACCS/ContainerComponent
...
JAR_TARGET = C:\Documents and Settings\!Fantazio!\My Documents\ACCS/ContainerComponent.jar
...
include RTbuild/ACCSSystem/ACCS_Container.cmk
...
RTbuild/ACCSSystem/ACCS_Container.ctg : $(ACCSSystem_ACCS__Container_DEPS_J) RTbuild/RTcompile.mbs
	$(JAVAC_WRAPPER) $(JAVAC_HEAD) ACCSSystem/ACCS_Container.java
