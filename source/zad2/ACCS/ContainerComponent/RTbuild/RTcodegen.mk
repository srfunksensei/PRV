...
COMPONENT = Component View::ContainerComponent
RTJAVAGEN = rtjavagen
...
ALL_GENERATION_TARGETS = \
	RTbuild/ACCSSystem/ACCS_Container.gtg \
...
include RTbuild/ACCSSystem/ACCS_Container.gmk
...
RTbuild/ACCSSystem/ACCS_Container.gtg : $(ACCSSystem_ACCS__Container_DEPS)
	$(RTGEN_CMD) -class "Logical View::ACCSSystem::ACCS_Container"
