...
import ACCSSystem.InjectEventParams;
...
public class CommandLeverSensor extends com.rational.rosert.Capsule
{
	...
	protected void rtTransition0_initial()
	{
		...
		// brake
		gui.addButtonEventBrake(new InjectEventBrake( (BrakeInterrupt.Conjugate) rtGetMsgData() ));

		// top gear
		gui.addButtonEventTopGear(new InjectEventTopGear( (EnableTopGear.Conjugate) rtGetMsgData() ));

		// activate
		gui.addButtonEventActivate(new InjectEventCommand( (LeverCommand.Conjugate) rtGetMsgData() ));
	...
	// }}}RME
	// {{{RME transition ':TOP:Deactivate:EngineOn:J4FC8E81302DF:topGearEngaged'
	protected void rtTransition3_topGearEngaged()
	{
		setTopGearEngaged(true);
